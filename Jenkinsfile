...
pipeline {
        ...
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                mvn sonar:sonar \
                  ...
                  -Dsonar.host.url=http://34.237.91.166:9000 \
                  -Dsonar.login=ff11ea06b7aa0c002cdcb16ec5826854a39a3e64
                """
                }
            }
        }
  ...
  post {
    always {
        ...
        slackSend channel: '#project', //update and provide your channel name
