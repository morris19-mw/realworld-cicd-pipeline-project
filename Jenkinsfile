...
pipeline {
            ...
            withSonarQubeEnv('SonarQube') { 
                ...
                sh """
                 mvn sonar:sonar \
                     ...
                     -Dsonar.host.url=http://35.174.184.111:9000 \
                     -Dsonar.login=4898df726928af1f91ba0136a05e5627d2ace0b1
                """
                }
            }
        }
  ...
  post {
    always {
        ...
        slackSend channel: '#process', //update and provide your channel name
